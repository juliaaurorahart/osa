...
try {
  ...
  assert.match(document.querySelector('[role="alert"]').textContent, /Draft is not saved/)
  failFlush = false
  await change(picker(), 'notebook:b', 'change')
  ...
  console.log('Notebook picker: deliberate names, flush-before-switch/create/rename, failure retention and scope-keyed forms passed.')
