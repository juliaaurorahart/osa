...
const allowed = new Set(['labDraftQueue', 'labDrafts', 'LabDraftContext', 'useLabWorkingDrafts', 'LabWorkbenchChromeContext', 'LabFileActions', 'LabMenu', 'labSections', 'labWorkspaceHandoff'])
