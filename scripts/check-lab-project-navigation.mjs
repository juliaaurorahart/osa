...
try {
  ...
  const notebookCommandInput = document.querySelector('[aria-label="Notebook command"]')
  notebookCommandInput.focus()
  ...
  assert.equal(document.activeElement, notebookCommandInput, 'A Library command keeps the cursor in the command line.')
